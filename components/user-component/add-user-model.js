...
function AddUserModel(props) {
    ...
    return <>
        <div id="popup-modal" tabindex="-1" class={`fixed top-0 left-0 right-0 z-50 ${props.ModelVisible ? 'block' : 'hidden'} p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full`}>
